...
def save_Dict_to_JSON(dict, file_path, file_name, with_indent=False):
...
if __name__ == '__main__':
    json_path = "D:\Research\Data\Intelligent_Feedback\Mistral_ZERO_combined_Refined.json"
    # load the json to dictionary and save with indent
    json_bugs = load_JSON_to_Dict(json_path)
    save_Dict_to_JSON(json_bugs, 'D:\Research\Data\Intelligent_Feedback', 'Mistral_ZERO_combined_Refined.json', with_indent=True)